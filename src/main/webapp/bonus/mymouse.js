(function() {
	...
	q(function() {
		...
		window.giffy_bp_0013 = {
			...
			mouseX: 0,
			mouseY: 0,
			init: function(fromPosition, toPosition) {
				for (i = 0; i < 1; i++) {
				...
				if(!fromPosition && !toPosition){
					q("html").mousemove(function(j) {
						...
						if (giffy_bp_0013.waitCnt == 0 && giffy_bp_0013.actionCount[giffy_bp_0013.curBallIdx] == 0){
							giffy_bp_0013.waitCnt = 2;
							giffy_bp_0013.actionCount[giffy_bp_0013.curBallIdx] = 1;
							giffy_bp_0013.curBallIdx = giffy_bp_0013.curBallIdx == 19 ? 0 : giffy_bp_0013.curBallIdx + 1;
						}
					});
				}else{
					...
					setInterval(function(){
						giffy_bp_0013.mouseX = currX;
						giffy_bp_0013.mouseY = currY;
						if (giffy_bp_0013.waitCnt == 0 && giffy_bp_0013.actionCount[giffy_bp_0013.curBallIdx] == 0){
							giffy_bp_0013.waitCnt = 2;
							giffy_bp_0013.actionCount[giffy_bp_0013.curBallIdx] = 1;
							giffy_bp_0013.curBallIdx = giffy_bp_0013.curBallIdx == 19 ? 0 : giffy_bp_0013.curBallIdx + 1;
						}
						currX = currX>=toX ? fromX : currX + 10;
						currY = currY>=toY ? fromY : currY + 10;
					}, 20);
				}
	...
	q(document).ready(function() {
		giffy_bp_0013.init([250,250],[1400,250])
	})
})();